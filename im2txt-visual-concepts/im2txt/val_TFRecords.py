...
from load_json import getValAttr, getNametoId
...
def main(_):
  ...
  img_path, annos_path, attrs_path, id_to_name_path = FLAGS.input_files.split(",")
  filename_to_attribute = getValAttr(attrs_path)
  imgid_to_filename = getNametoId(id_to_name_path)
  ...
  with tf.Session(graph=g) as sess:
    ...
    try:
      while not coord.should_stop(): #loop forever
        ...
        attribute = filename_to_attribute[imgid_to_filename[img_id]]
        captions = generator.beam_search(sess, encoded_image, attribute)
