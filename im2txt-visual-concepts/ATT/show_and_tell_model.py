...
from ATT.ops import image_embedding
from ATT.ops import image_processing
from ATT.ops import inputs as input_ops
  ...
  def build_inputs(self):
    ...
    if self.mode == "inference":
      ...
      for thread_id in range(self.config.num_preprocess_threads):
        ...
        encoded_image, caption, attribute = input_ops.parse_sequence_example(
      ...
      images, input_seqs, input_attrs, target_seqs, input_mask = (
