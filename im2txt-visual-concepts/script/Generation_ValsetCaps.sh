...
CHECKPOINT_PATH="${HOME}/projects/ic_models/im2txt-visual-concepts/A5/model/adam"
...
OUTPUT_FILE="${HOME}/projects/ic_models/im2txt-visual-concepts/A5/results/results_val.json"
