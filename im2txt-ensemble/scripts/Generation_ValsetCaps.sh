...
CHECKPOINT_PATH="${HOME}/projects/ic_models/im2txt-visual-concepts/A5/model/adam2"
...
OUTPUT_FILE="${HOME}/projects/ic_models/im2txt-visual-concepts/A5/results/results_a5.json"
