...
CHECKPOINT_PATH="${HOME}/projects/ic_models/im2txt-ensemble/ensemble/model/2/"
...
IMAGE_FILE="${HOME}/projects/ic_models/im2txt-visual-concepts/im2txt/data/mscoco-visual-concepts/raw-data/val2014/COCO_val2014_000000224477.jpg,${HOME}/projects/ic_models/im2txt-visual-concepts/im2txt/data/mscoco-visual-concepts/raw-data/val2014/COCO_val2014_000000000042.jpg"

# Build the inference binary.
cd ${HOME}/projects/ic_models/im2txt-ensemble
bazel build -c opt //ensemble:run_inference
...
bazel-bin/ensemble/run_inference \
