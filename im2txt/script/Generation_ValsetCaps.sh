...
# CHECKPOINT_PATH="${HOME}/projects/ic_models/im2txt/im2txt/model/blend_mscoco_with_flickr30"
...
# VOCAB_FILE="${HOME}/projects/ic_models/im2txt/im2txt/data/blend_mscoco_with_flickr30/word_counts.txt"
...
# OUTPUT_FILE="${HOME}/projects/ic_models/im2txt/resnet152/results/results_val_resnet152_1m.json"
# OUTPUT_FILE="${HOME}/projects/ic_models/im2txt/im2txt/results/results_val_blend_new.json"
# OUTPUT_FILE="${HOME}/projects/ic_models/im2txt/inceptionv4/results/results_val_inceptionv4_new.json"
